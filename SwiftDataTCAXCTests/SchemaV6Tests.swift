...
final class SchemaV6Tests: XCTestCase {
  ...
  func testCreatingV5Database() async throws {
    ...
    var movies = try! context.fetch(SchemaV6.movieFetchDescriptor(titleSort: .forward, searchString: ""))
    ...
    movies = try! context.fetch(SchemaV6.movieFetchDescriptor(titleSort: .reverse, searchString: ""))
    ...
    movies = try! context.fetch(SchemaV6.movieFetchDescriptor(titleSort: .forward, searchString: "th"))
